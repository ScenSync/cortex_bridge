//! Launcher tests for NetworkInstance creation and configuration
//!
//! These tests verify that NetworkInstance can be created with various configurations
...
async fn test_private_mode_launcher() {
    ...
    let cfg =
        TomlConfigLoader::new_from_str(toml_config).expect("Failed to parse test configuration");
