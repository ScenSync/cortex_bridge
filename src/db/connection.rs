...
use sea_orm::{Database as SeaOrmDatabase, DatabaseConnection, DbErr, ConnectionTrait};
...
pub async fn establish_connection(database_url: &str) -> Result<DatabaseConnection, DbErr> {
    ...
    let orm_conn = SeaOrmDatabase::connect(database_url)
        .await
        .map_err(|e| {
...
pub async fn test_connection(database_url: &str) -> Result<(), DbErr> {
    let conn = SeaOrmDatabase::connect(database_url)
        .await
        .map_err(|e| {
